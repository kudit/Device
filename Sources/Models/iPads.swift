...
public struct iPad: IdiomType, HasScreen, HasCameras, HasCellular {
    ...
    public static let all = [ // Public for DeviceKit testing
        ...
        iPad(
            officialName: "iPad Pro 11-inch (M5)",
            identifiers: ["iPad17,1", "iPad17,2"],
            ...
            pencils: [.usbC, .pro]),
        iPad(
            officialName: "iPad Pro 13-inch (M5)",
            identifiers: ["iPad17,3", "iPad17,4"],
            introduction: "2025-10-22",
            supportId: "125407",
            launchOSVersion: "26.0.1",
            unsupportedOSVersion: nil,
            image: "https://cdsassets.apple.com/live/7WUAS350/images/ipad/fall-2025-ipad-pro-m5-13in.png",
            capabilities: [.pro, .usbC, .thunderbolt, .biometrics(.faceID), .esim, .roundedCorners, .lidar, .barometer, .appleIntelligence],
            models: ["A3360", "A3361", "A3362"],
            colors: [.macbookSpaceblack, .solidSilver],
            cpu: .m5,
            cameras: [.wide, .trueDepth12MP],
            cellular: .fiveG,
