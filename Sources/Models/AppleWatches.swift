...
public struct AppleWatch: IdiomType, HasScreen, HasCellular {
    ...
    public static let all = [ // since various materials use same identifier, by convention, use the aluminum versions for smaller and most expensive versions for larger body version.  // Public for DeviceKit testing
        ...
        AppleWatch(
            ...
            capabilities: [.roundedCorners, .compass, .fallDetection, .electrocardiogram, .alwaysOnDisplay, .oxygenSensor],
        ...
        AppleWatch(
            ...
            capabilities: [.roundedCorners, .compass, .fallDetection],
        ...
        AppleWatch(
            ...
            capabilities: [.roundedCorners, .compass, .fallDetection, .electrocardiogram, .alwaysOnDisplay, .oxygenSensor, .crashDetection],
        ...
        AppleWatch(
            ...
            capabilities: [.roundedCorners, .compass, .fallDetection, .crashDetection],
        ...
        AppleWatch(
            ...
            capabilities: [.roundedCorners, .compass, .fallDetection, .electrocardiogram, .alwaysOnDisplay, .oxygenSensor, .crashDetection, .actionButton],
        ...
        AppleWatch(
            ...
            capabilities: [.roundedCorners, .compass, .fallDetection, .crashDetection, .alwaysOnDisplay],
