...
public struct AppleWatch: IdiomType, HasScreen, HasCellular {
    ...
    // since various materials use same identifier, by convention, use the aluminum versions for GPS only models and premium versions for GPS + Cellular versions.
        ...
        AppleWatch(
            ...
            capabilities: [.roundedCorners, .compass, .fallDetection, .electrocardiogram, .alwaysOnDisplay, .oxygenSensor, .cellular(.lte)],
            models: ["A2293", "A2375"],
            colors: .watch6,
            cpu: .s6,
            size: .mm40),
        ...
        AppleWatch(
            ...
            capabilities: [.roundedCorners, .compass, .fallDetection, .electrocardiogram, .alwaysOnDisplay, .oxygenSensor, .crashDetection, .cellular(.lte)],
        ...
        AppleWatch(
            ...
            capabilities: [.roundedCorners, .compass, .fallDetection, .crashDetection, .cellular(.lte)],
        ...
        AppleWatch(
            ...
            capabilities: [.roundedCorners, .compass, .fallDetection, .electrocardiogram, .alwaysOnDisplay, .oxygenSensor, .crashDetection, .actionButton, .cellular(.lte)],
        ...
        AppleWatch(
            ...
            unsupportedOSVersion: nil,
            image: "https://cdsassets.apple.com/live/7WUAS350/images/apple-watch/apple-watch-se-3.png",
            capabilities: [.compass, .fallDetection, .crashDetection, .alwaysOnDisplay, .cellular(.lte)],
            models: ["A3326", "A3327"],
            colors: .watchSE3,
            cpu: .s10,
            size: .mm40),
