...
public struct Mac: IdiomType {
    public enum Form: String, Hashable, CaseIterable, CaseNameConvertible, Sendable, Codable {
...
//        case macProGen3Server = "macpro.gen3.server" // MacPro Rack configuration
    ...
    public static let all = [ // Public for DeviceKit testing
        ...
        Mac(
            ...
            capabilities: [.air, .usbC, .magSafe1],
        ...
        Mac(
            ...
            capabilities: [.pro, .usbC, .magSafe1],
            models: ["MD311xx/A"],
            colors: .legacySilverMacs,
            cpu: .intel),
        Mac(
